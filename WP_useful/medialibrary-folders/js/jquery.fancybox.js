...
function responzive_fancy() {
    var win_width = $(window).width();

    if (win_width > 785) {

        initLightbox(700);
    } else if (win_width > 600 && win_width <= 785) {

        initLightbox(500);
    } else if (win_width > 400 && win_width <= 600) {
...
function initLightbox(width) {
    ...
    jQuery('a[rel*="lightbox-i"]').fancybox({
        loop: false,
        helpers: {
            overlay: {
                css: {
    ...
    jQuery('a[rel*="lightbox-v"]').fancybox({
        loop: false,
        helpers: {
            overlay: {
                css: {
